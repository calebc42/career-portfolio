...
# --- EXECUTION ---
# IMPORTANT: Replace this path with the actual path to your skills folder in WSL2
# Note: This should point to the 'skills' folder inside your project's 'data' directory
my_skills_path = '~/projects/career-portfolio/data/skills' 

# On WSL2, Python's os.path.expanduser can handle the '~' symbol
