...
# --- EXECUTION ---
my_skills_path = '~/projects/career-portfolio/data/skills'
absolute_skills_path = os.path.expanduser(my_skills_path)
master_keyword_list = get_all_keywords(absolute_skills_path)
